...
const Auth=()=>{
        ...
        fetch(`${API_BASE_URL}/user/login`,{
            ...
            if(!response.ok){
                ...
                return response.json().then((data)=>{
                    ...
                    cookies.set("FULLNAME",data.role,{
                        path:"/",
                    })
                    setpassword('')
                    setusername('')
    ...
    return(
        ...
        <div className="flex h-screen items-center justify-center flex-col">
         <div className="text-4xl flex text-orange-500 pb-20"><i className="text-white p-1 text-bold mr-1 text-2xl bg-black rounded"><FontAwesomeIcon icon={faSwatchbook}/></i> Educad</div>
        {bool?<>
